...
Tracing (USDT) support for Bitcoin Deis on Linux using. For more information on
USDT support in Bitcoin Deis see the [USDT documentation].
...
[Bitcoin Deis USDT documentation] on how to list available tracepoints in your
`bitcoind` binary.

[Bitcoin Deis USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
In a different terminal, starting Bitcoin Deis in SigNet mode and with
re-indexing enabled.
