# PSBT Howto for Bitcoin Deis

Since Bitcoin Deis 0.17, an RPC interface exists for Partially Signed Bitcoin
...
#### Multisig with multiple Bitcoin Deis instances
...
Bitcoin Deis. We assume their wallets only contain the multisig funds. In case
