...
- [Development guidelines](#development-guidelines)
    - [General Bitcoin Deis](#general-bitcoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Bitcoin Deis uses [Doxygen](https://www.doxygen.nl/) to generate its official documentation.
...
Bitcoin Deis is a multi-threaded application, and deadlocks or other
...
Bitcoin Deis can be compiled with various "sanitizers" enabled, which add
...
However, in open source software such as Bitcoin Deis, where everyone uses
...
pay attention to for reviewers of Bitcoin Deis code.

General Bitcoin Deis
----------------------
...
- For `strprintf`, `LogInfo`, `LogDebug`, etc formatting characters don't need size specifiers.
  ...
  - *Rationale*: Bitcoin Deis uses tinyformat, which is type safe. Leave them out to avoid confusion.
...
Some of these are maintained by active developers of Bitcoin Deis, in which case
...
a Bitcoin Deis subtree, so that they can be integrated quickly. Cosmetic changes
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Bitcoin Deis, the wallet was always
