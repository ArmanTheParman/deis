...
Checkout the Bitcoin Deis version you'd like to build:
...
- Announce the release:
  ...
  - Bitcoin Deis announcements list https://bitcoincore.org/en/list/announcements/join/

  - Bitcoin Deis Twitter https://twitter.com/bitcoincoreorg
