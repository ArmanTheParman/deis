# CJDNS support in Bitcoin Deis

It is possible to run Bitcoin Deis over CJDNS, an encrypted IPv6 network that
...
done outside of Bitcoin Deis, similarly to a VPN (either in the host/OS or on
...
before it will work with your Bitcoin Deis node. This is described in steps
...
## Run Bitcoin Deis with CJDNS

Once you are connected to the CJDNS network, the following Bitcoin Deis
...
When enabled, this option tells Bitcoin Deis that it is running in an
...
IPv6 local network. This helps Bitcoin Deis perform better address management:
...
CJDNS support was added to Bitcoin Deis in version 23.0 and there may be fewer
...
## CJDNS-related information in Bitcoin Deis

There are several ways to see your CJDNS address in Bitcoin Deis:
