When Bitcoin Deis automatically opens outgoing P2P connections, it chooses
...
and usually require authentication. A connection attempt (by Bitcoin Deis,
...
Below is a list of "bad" ports which Bitcoin Deis avoids when choosing a peer to
