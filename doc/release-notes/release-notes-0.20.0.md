...
Bitcoin Deis version 0.20.0 is now available from:
...
#### Removal of BIP61 reject network messages from Bitcoin Deis

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Bitcoin Deis version 0.18.0.
...
- Testing or debugging of implementations of the Bitcoin P2P network protocol
  ...
  version of Bitcoin Deis. Bitcoin Deis logs debug messages
...
- OpenSSL is no longer used by Bitcoin Deis.  (#17265)

- BIP70 support has been fully removed from Bitcoin Deis. The
...
- All custom settings configured when Bitcoin Deis starts are now
...
- The "Start Bitcoin Deis on system login" option has been removed on macOS.
  (#17567)
...
- A "known bug" [announced](https://bitcoincore.org/en/releases/0.18.0/#wallet-gui)
  ...
  affected anyone who simultaneously used multiple Bitcoin Deis wallets
...
- For watch-only wallets, creating a new transaction in the Send screen
  ...
  signing.  Future versions of Bitcoin Deis should support a GUI option
...
- Bitcoin Deis's automatically-generated source code documentation is
...
- #16983 Add detailed info about Bitcoin Deis files (hebasto)
