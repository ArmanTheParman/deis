Bitcoin Deis version 27.0 is now available from:
...
- A C++20 capable compiler is now required to build Bitcoin Deis. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Bitcoin Deis would
