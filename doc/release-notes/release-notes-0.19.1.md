...
Bitcoin Deis version 0.19.1 is now available from:
...
From Bitcoin Deis 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bitcoin Deis is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bitcoin Deis does not yet change appearance when
