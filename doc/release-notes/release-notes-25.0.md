...
Bitcoin Deis version 25.0 is now available from:
...
dbcache, Bitcoin Deis will now return an error at startup. (#25574)
...
before Bitcoin Deis has begun its shutdown sequence. (#23395)
