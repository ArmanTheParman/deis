...
Bitcoin Deis version 24.0.1 is now available from:
...
This version of Bitcoin Deis adds a new `mempoolfullrbf` configuration
...
fees, was realized in [Bitcoin Deis 0.12.0][] (February 2016) with the
...
default for years, and several contributors to Bitcoin Deis are
...
[Bitcoin Deis 0.12.0]: https://bitcoincore.org/en/releases/0.12.0/#opt-in-replace-by-fee-transactions
...
- To help prevent fingerprinting transactions created by the Bitcoin Deis wallet, change output
