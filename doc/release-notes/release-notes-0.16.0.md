Bitcoin Deis version 0.16.0 is now available from:
...
Bitcoin Deis now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Bitcoin Deis is now 4.8. No effort will be
