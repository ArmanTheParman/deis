Bitcoin Deis version 0.13.1 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of Bitcoin Deis
...
- **More efficient almost-full-node security** Satoshi Nakamoto's original
  ...
  note that Bitcoin Deis does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Bitcoin users to individually opt-in to almost any change in the Bitcoin
  Script language when those users receive new transactions.  Features
  currently being researched by Bitcoin Deis contributors that may use this
...
Since Bitcoin Deis 0.10.0, nodes have defaulted to only relaying and
