...
Bitcoin Deis version 26.0 is now available from:
...
- Wallet loading has changed in this release. Wallets with some corrupted records that could be
  ...
  load the wallet in a previous version of Bitcoin Deis and import the data into a new wallet.
...
- The usage of hybrid public keys in output descriptors has been removed. Hybrid
  ...
  (as specified in BIP380 and documented in doc/descriptors.md). Bitcoin Deis would
