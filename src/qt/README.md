This directory contains the source code for the Bitcoin Deis graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
9. You're all set! Start developing, building, and debugging the Bitcoin Deis GUI
