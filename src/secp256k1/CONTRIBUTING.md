...
The library primarily serves the needs of the Bitcoin Deis project but provides additional functionality for the benefit of the wider Bitcoin ecosystem.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to Bitcoin Deis's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/bitcoin/bitcoin/blob/master/CONTRIBUTING.md).
...
* As a rule of thumb, the default values for configuration options should target standard desktop machines and align with Bitcoin Deis's defaults, and the tests should mostly exercise the default configuration (see [#1549](https://github.com/bitcoin-core/secp256k1/issues/1549#issuecomment-2200559257)).
