...
We aim to cut a regular release every 3-4 months, approximately twice as frequent as major Bitcoin Deis releases. Every second release should be published one month before the feature freeze of the next major Bitcoin Deis release, allowing sufficient time to update the library in Core.
