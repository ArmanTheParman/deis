Contributing to Bitcoin Deis
============================

The Bitcoin Deis project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Bitcoin Deis
...
Before you start contributing, familiarize yourself with the Bitcoin Deis build
system and tests. Refer to the documentation in the repository on how to build
Bitcoin Deis and how to run the unit tests, functional tests, and fuzz tests.
...
[Bitcoin Deis PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about Bitcoin Deis development happens on IRC, in the
...
fork of Bitcoin Deis copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Bitcoin Deis project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitcoin
Network Protocol consensus changes.

Whether a pull request is merged into Bitcoin Deis rests with the project merge
maintainers.
